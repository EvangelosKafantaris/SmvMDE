function [Out_mvDE, npdf]=ST_SmvDE_NCDF(X,m,c,stau,designated_signal,threshold,reduced_weight)
...
% the denominator is calculated based on the respective weights of each
% category
